# ~/.nix/shared/powerlevel10k.nix
{ pkgs, ... }:
{
  programs.zsh.plugins = [
    {
      name = "my-powerlevel10k-config";
      src = pkgs.writeTextDir "p10k.zsh" ''
        # Generated by Powerlevel10k configuration wizard on 2023-08-20 at 14:09 EDT.
