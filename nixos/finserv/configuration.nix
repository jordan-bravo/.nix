...

{
  ...
  systemd.services = {
    ...
    #     ExecStart = [
    #       # ACINQ
    #       "${pkgs.coreutils}/bin/echo \"$(date) before\" >> /var/lib/lnd/lnd-service.log"
    ...
    #       # put timestamp in lnd-service.log
    #       "${pkgs.coreutils}/bin/echo \"$(date) after\" >> /var/lib/lnd/lnd-service.log"
    #     ];
    #   };
    # };
    my-test-service = {
